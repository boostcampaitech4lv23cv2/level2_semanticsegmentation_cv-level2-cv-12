...
def get_args():
    ...
    parser.add_argument("--input_dir", default="/opt/ml/input/data/mmseg/train", type=str,
                        help="input annotated directory")
    parser.add_argument("--output_dir", default="/opt/ml/input/data/mmseg/copy_paste", type=str,
